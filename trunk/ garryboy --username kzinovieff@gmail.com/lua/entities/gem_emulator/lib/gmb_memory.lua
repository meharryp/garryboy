...
-- Window Scroll X
MRead[ 0xFF4A ] = function( self, Addr ) return self.WindowX end
MWrite[ 0xFF4A ] = function( self, Addr, Data ) self.WindowX = Data end

-- Window Scroll Y
MRead[ 0xFF4B ] = function( self, Addr ) return self.WindowY end
MWrite[ 0xFF4B ] = function( self, Addr, Data ) self.WindowY = Data end



-- Current Scanline Register
MRead[ 0xFF44 ] = function( self, Addr ) return self.ScanlineY end
MWrite[ 0xFF44 ] = function( self, Addr, Data ) end -- Do nothing, can't write to scanline register
